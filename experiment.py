    ...
    def __init__(self,PARAMETERS):
        ...
        with tensorflow.Session() as sess:
            ...
            if PARAMETERS.LOAD_MODEL == True:
                print ('Loading Model...')
                ckpt = tensorflow.train.get_checkpoint_state(PARAMETERS.MODEL_FILE_PATH)
                saver.restore(sess, ckpt.model_checkpoint_path)
            else:
                sess.run(tensorflow.global_variables_initializer())

            # Initialize Tensorboard Summary
            self.summary_writer = tensorflow.summary.FileWriter(PARAMETERS.RESULTS_PATH + "summary", sess.graph)
